...
describe('PrivateKey', function() {
  ...
  var wiftestnetmgv = 'cSdkPxkAjA4HDr5VHgsebAPDEh9Gyub4HK8UJr2DFGGqKKy4K5sG';
  var wiftestnetmgvUncompressed = '92jJzK4tbURm1C7udQXxeCBvXHoHJstDXRxAMouPG1k1XUaXdsu';
  var wiflivenetmgv = 'L2Gkw3kKJ6N24QcDuH4XDqt9cTqsKTVNDGz1CRZhk9cq4auDUbJy';
  var wiflivenetmgvUncompressed = '5JxgQaFM1FMd38cd14e3mbdxsdSa9iM2BV6DHBYsvGzxkTNQ7Un';
  ...
  describe('instantiation', function() {
    ...
    it('should not be able to instantiate private key because of network mismatch', function() {
      expect(function() {
        return new PrivateKey('L3T1s1TYP9oyhHpXgkyLoJFGniEgkv2Jhi138d7R2yJ9F4QdDU2m', 'testnetmgv');
    ...
    it('should not be able to instantiate private key WIF because of network mismatch', function() {
      expect(function(){
        var a = new PrivateKey(wifNamecoin, 'testnetmgv');
      }).to.throw('Invalid network');
    });
  ...
  describe('#json/object', function() {
    ...
    it('input json should correctly initialize network field', function() {
      ['livenetmgv', 'testnetmgv', 'mainnet'].forEach(function (net) {
  ...
  describe('#toString', function() {
    ...
    it('should output this address correctly', function() {
      var privkey = PrivateKey.fromWIF(wiflivenetmgvUncompressed);
      privkey.toWIF().should.equal(wiflivenetmgvUncompressed);
    });
  ...
  describe('#inspect', function() {
    ...
    it('outputs "uncompressed" for uncompressed imported WIFs', function() {
      var privkey = PrivateKey.fromWIF(wiflivenetmgvUncompressed);
      privkey.inspect().should.equal('<PrivateKey: 96c132224121b509b7d0a16245e957d9192609c5637c6228311287b1be21627a, network: livenetmgv, uncompressed>');
    });
  });
  ...
  describe('#toBigNumber', function() {
    it('should output known BN', function() {
      ...
      var privkey = new PrivateKey(a, 'livenetmgv');
  ...
  describe('#toPublicKey', function() {
    ...
    it('should convert this known PrivateKey to known PublicKey and preserve compressed=true', function() {
      ...
      var privkey = new PrivateKey(privwif, 'livenetmgv');
      var pubkey = privkey.toPublicKey();
    ...
    it('should convert this known PrivateKey to known PublicKey and preserve compressed=false', function() {
      ...
      var privkey = new PrivateKey(privwif, 'testnetmgv');
      var pubkey = privkey.toPublicKey();
