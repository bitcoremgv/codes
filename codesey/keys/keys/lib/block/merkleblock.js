...
MerkleBlock.prototype.validMerkleTree = function validMerkleTree() {
  ...
  // Can't have more flagBits than num hashes
 ...
 * Modeled after MegaVolatility Core merkleblock.cpp TraverseAndExtract()
 * @param {Number} - depth - Current height
 * @param {Number} - pos - Current position in the tree
 * @param {Object} - opts - Object with values that need to be mutated throughout the traversal
 * @param {Number} - opts.f - Number of flag used, should start at 0
 ...
 *  Modeled after MegaVolatility Core merkleblock.h CalcTreeWidth()
