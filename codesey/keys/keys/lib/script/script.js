...
/**
 * A megavolatility transaction script. Each transaction's inputs and outputs
 * has a script that is evaluated to validate it's spending.
 *
 * See https://en.megavolatility.it/wiki/Script
 *
 * @constructor
...
/**
 * Analogous to megavolatilityd's FindAndDelete. Find and delete equivalent chunks,
...
/**
 * Comes from megavolatilityd's script interpreter CheckMinimalPush function
...
/**
 * Comes from megavolatilityd's script DecodeOP_N function
 * @param {number} opcode
...
/**
 * Comes from megavolatilityd's script GetSigOpCount(boolean) function
