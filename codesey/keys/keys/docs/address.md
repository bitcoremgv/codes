...
Represents a megavolatility address. Addresses are the most popular way to make megavolatility transactions. See [the official MegaVolatility Wiki](https://en.bit.it/wiki/Address) for technical background information.
