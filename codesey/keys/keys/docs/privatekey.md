# Private Key
Represents a megavolatility private key and is needed to be able to spend megavolatility and sign transactions. See the official [MegaVolatility Wiki](https://en.megavolatility.it/wiki/Private_key) for more information about private keys. A PrivateKey in Bitcore is an immutable object that has methods to import and export into a variety of formats including [Wallet Import Format](https://en.megavolatility.it/wiki/Wallet_import_format).
